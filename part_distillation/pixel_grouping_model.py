...
class PixelGroupingModel(nn.Module):
    ...
    def prepare_mask(self, inputs, images):
        ...
        new_targets = []
        for part_targets_per_image, object_pargets_per_image in zip(part_targets, object_targets):
            ...
            object_gt_mask = object_pargets_per_image.gt_masks.tensor
            ...
            new_targets.append({"part_labels": part_targets_per_image.gt_classes.to(self.device),
                                "object_label": object_pargets_per_image.gt_classes.to(self.device),
    ...
    def forward(self, batched_inputs):
        ...
        with torch.no_grad():
            ...
            if comm.is_main_process():
                if self.num_test_iterations % self.wandb_vis_period == 0:
