...
"""
Example:
    ./dev/fair/launch.py --config-file test.yaml --num-gpus 8 \
        -p dev --name test
    ./dev/fair/launch.py --config-file \
        parts/configs/ade20k/faster_rcnn_R_50_FPN_pascal_parts.yaml \
        --num-gpus 8 -p dev --name test
"""
